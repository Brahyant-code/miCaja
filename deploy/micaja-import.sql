...
-- VERSIÓN PARA IMPORTAR EN InfinityFree (phpMyAdmin)
--
-- Diferencia con database/micaja.sql: se quitaron las líneas
-- "CREATE DATABASE" y "USE", porque en InfinityFree la base de datos
-- ya está creada desde el panel y solo puedes importar dentro de ella.
--
-- Pasos: en phpMyAdmin selecciona tu BD (if0_XXXX_micaja) y usa
-- la pestaña "Importar" con este archivo.
-- ================================================
